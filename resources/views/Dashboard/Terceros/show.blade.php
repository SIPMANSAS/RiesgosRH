                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-4 form-group">
                                ...
                                <select name="tipo_identificacion" class='form-control' disabled>
                                    <option value="" selected disabled>Seleccione una opcion</option>
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                {!! Form::date('fecha_expedicion', $Terceros->fecha_expedicion, ['class' => 'form-control', 'disabled']) !!}
                            </div>
                            <div class="col-sm-4 form-group">
                                {!! Form::label('pais_expedicion') !!} <span style="color: red">*</span>
                                <select name="pais_expedicion" id="pais_expedicion" class='form-control' disabled>
                                    <option value="" selected disabled>Seleccione una opcion</option>
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                <select name="ciudad_expedicion" id="ciudad_expedicion" class='form-control' disabled>
                                    <option value="" selected disabled>Seleccione una opcion</option>
                                </select>
                            </div>
                            <div class="col-sm-6 form-group">
                                {!! Form::label('nombres') !!} <span style="color: red">*</span>
                                {!! Form::text('nombres', $Terceros->nombres, ['class' => 'form-control', 'disabled']) !!}
                            </div>
                            <div class="col-sm-6 form-group">
                                {!! Form::label('apellidos') !!} <span style="color: red">*</span>
                                {!! Form::text('apellidos', $Terceros->apellidos, ['class' => 'form-control', 'disabled']) !!}
                            </div>
                            <div class="col-sm-4 form-group">
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                {!! Form::text('direccion', $Terceros->direccion, ['class' => 'form-control', 'disabled']) !!}
                            </div>
                            <div class="col-sm-4 form-group">
                                {!! Form::label('correo electronico') !!} <span style="color: red">*</span>
                                {!! Form::email('correo_electronico', $Terceros->correo_electronico, ['class' => 'form-control', 'disabled']) !!}
                            </div>
                            <div class="col-sm-4 form-group">
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                {!! Form::date('fecha_nacimiento', $Terceros->fecha_nacimiento, ['class' => 'form-control', 'disabled']) !!}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4 form-group">
                                ...
                                <select name="nacionalidad" class='form-control' disabled>
                                    <option value="" selected disabled>Seleccione una opcion</option>
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                <select name="idioma" class='form-control' disabled>
                                    <option value="" selected disabled>Seleccione una opcion</option>
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                <select name="profesion" class='form-control' disabled>
                                    <option value="" selected disabled>Seleccione una opcion</option>
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                <select name="tipo_tercero" class='form-control' disabled>
                                    <option value="" selected disabled>Seleccione una opcion</option>
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                <select name="categoria_terceo" class='form-control' disabled>
                                    <option value="" selected disabled>Seleccione una opcion</option>
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                <select name="segmento_tercero" class='form-control' disabled>
                                    <option value="" selected disabled>Seleccione una opcion</option>
